...
<body>
    <div class="container">
        ...
        <div class="buttons">
            ...
            <a href="http://127.0.0.1:5001" class="btn" target="_blank" style="background-color: #007bff; color: #fff; border: none; border-radius: 5px; cursor: pointer; padding: 10px 20px; text-decoration: none;">Bot</a>
